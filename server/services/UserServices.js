...
const VerifyOTPService = async (req) => {
    try {
        ...
        console.error("VerifyOTPService error:", e);
        return { status: "fail", message: "Something went wrong" };
    }
}
...
const ReadProfileService = async (req) => {
    try {
        ...
        console.error("ReadProfileService error:", e);
...
const RegisterOTPService = async (req) => {
    try {
        ...
        console.error("RegisterOTPService error:", error);
        return { status: "fail", message: "Something went wrong" };
    }
}
...
const LoginWithPasswordService = async (req) => {
    try {
        ...
        console.error("LoginWithPasswordService error:", e);
        return { status: "fail", message: "Something went wrong" };
    }
}
